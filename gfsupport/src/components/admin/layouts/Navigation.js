        ...
        <div>
            <nav className="p-1 d-flex">
                <div className="container-fluid py-2 m-4 d-flex  justify-content-between">
                    <div className="col-1 col-lg-5 col-md-4 col-sm-2">
                        <img src={logo} alt="Home"  />
                    </div>
                    <div className="col-1 pr-4 d-flex justify-content-between">
                        <BsBellFill style={{ fontSize: "24px", marginTop: "5px", color: "#2B2B2B"}}>
                            <span class="badge bg-secondary">9</span>
                        </BsBellFill>
                        <div className="mt-1 bg-secondary rounded-circle" id="PopoverFocus" style={{ width : "25px", overflow: "hidden", height : "25px"}} onClick={toogle}>
